...
[abb6]
Mit diesem Aufbau ist die frequenzabhängige Brückenspannung $U_Br$ zu bestimmen. Das Spannungsverhältnis
zwischen der Speisespannung $U_S$ und $U_r$ lässt sich durch \begin{equation}
    \abs{\frac{U_Br}{U_S}}^2 = \frac{(\omega^2 R^2 C^2 -1)^2}{9\bigl (1- \omega^2 R^2 C^2)^2 + 9\omega^2 R^2 C^2\bigr}
\end{equation}
...
Spannungsverhältnis \begin{equation}
    \abs{\frac{U_Br}{U_S}}^2 = \frac{(\Omega^2 -1)^2}{9(1- \Omega^2)^2 + 9\Omega^2}
\end{equation}
