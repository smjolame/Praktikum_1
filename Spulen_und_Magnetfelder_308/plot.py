...
plt.plot(x5, y5,'b.', label='Helmholtzspule Abstand 6,25')
plt.xlabel(r'$x \:/\: \si{\cm}$')
plt.ylabel(r'$B \:/\: \si{\milli\tesla}$')
plt.legend(loc='best')
plt.grid()
...
plt.plot(x6, y6,'b.', label='Helmholtzspule Abstand 12,5')
plt.xlabel(r'$x \:/\: \si{\cm}$')
plt.ylabel(r'$B \:/\: \si{\milli\tesla}$')
plt.legend(loc='best')
plt.grid()
...
plt.plot(x7, y7,'b.', label='Helmholtzspule Abstand 18,75')
plt.xlabel(r'$x \:/\: \si{\cm}$')
plt.ylabel(r'$B \:/\: \si{\milli\tesla}$')
plt.legend(loc='best')
plt.grid()
