...
\label{sec:Durchführung}
    ...
    \subsection{Helmholtz-Spule}
        ...
        Ein Helmholtz-Spulen-Paar besteht aus zwei identischen Spulen, die parallel zueinander
        in einem Abstand $d$ angeordnet sind. Der Radius $R$ einer Spule ist 6,25 \si{\centi\meter}
