...
Hierbei wird die selbe Stange verwendet. Auf beiden Seiten wird jeweils eine Masse $m$ in gleichem Abstand zur 
...
\begin{figure}
    ...
    \caption{Verschiedene Zylinder.(Quelle \cite{V101})}
...
\begin{figure}
    ...
    \caption{Puppe in Pos. 1. (Quelle: privat)}
    \label{fig:puppe_2}
\end{figure}
...
\begin{figure}
    ...
    \caption{Puppe in Pos. 2. (Quelle: privat)}
    \label{fig:puppe_1}
\end{figure}
